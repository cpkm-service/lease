...
<div class="block block-rounded">
    <div class="block-header block-header-default">
        ...
        <a href="{{ route('backend.lease.contract_order.create') }}" class="btn btn-primary create">{{ __('create') }}</a>
    </div>
    <div class="block-content block-content-full">
...
<script type="text/javascript">
    var url = "{{route('backend.lease.contract_order.index',[],false)}}";
    var search = makeDataTable(
        ...
        [
            ...
            },
            {
                ...
                title: "{{__('lease::backend.lease_contract_orders.date')}}"
            },
            {
                data: "no",
                className: "text-md-center",
                title: "{{__('lease::backend.lease_contract_orders.no')}}"
            },
            {
                data: "customer.name",
                className: "text-md-center",
                title: "{{__('lease::backend.lease_contract_orders.customers_id')}}"
            },
            {
                data: "method.name",
                className: "text-md-center",
                title: "{{__('lease::backend.lease_contract_orders.lease_methods_id')}}"
            },
            {
                data: "customer_contact.name",
                className: "text-md-center",
                title: "{{__('lease::backend.lease_contract_orders.customer_contacts_id')}}"
            },
            {
                data: "customer_phone",
                className: "text-md-center",
                title: "{{__('lease::backend.lease_contract_orders.customer_phone')}}"
            },
            {
                data: "id",
                className: "text-md-center",

...
return new class extends Migration
{
    ...
    {
        Schema::create('lease_quote_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedTinyInteger('lease_quote_order_statuses_id')->default(1)->comment('狀態');
    ...
    {
        Schema::dropIfExists('lease_quote_orders');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('lease_contract_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedTinyInteger('lease_contract_order_statuses_id')->default(1)->comment('狀態');
    ...
    {
        Schema::dropIfExists('lease_contract_orders');
    }
};

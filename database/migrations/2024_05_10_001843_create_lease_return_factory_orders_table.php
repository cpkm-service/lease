...
return new class extends Migration
{
    ...
    {
        Schema::create('lease_return_factory_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedTinyInteger('lease_return_factory_order_statuses_id')->default(1)->comment('狀態');
    ...
    {
        Schema::dropIfExists('lease_return_factory_orders');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('lease_contract_order_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('lease_contract_order_id')->comment('租賃合約單id');
            $table->unsignedBigInteger('lease_quote_order_item_id')->nullable()->comment('租賃報價單項目id');
    ...
    {
        Schema::dropIfExists('lease_contract_order_items');
    }
};
